        ...
        <SafeAreaView style={{ backgroundColor: colors.background }} className="flex-1" edges={['top']}>
            ...
            <View style={{ borderBottomColor: colors.border }} className="px-6 py-4 flex-row items-center justify-between border-b">
                ...
                <View className="items-center">
                    <Text style={{ color: colors.textSecondary }} className="text-[10px] font-black tracking-[2px] uppercase opacity-60">Ticket Status</Text>
                    <View className="flex-row items-center mt-0.5">
                        <View style={{ backgroundColor: statusTheme.color }} className="w-1.5 h-1.5 rounded-full mr-2" />
                        <Text style={{ color: statusTheme.color }} className="text-xs font-black tracking-widest uppercase">{ticket.status}</Text>
                    </View>
                </View>
                <TouchableOpacity
            ...
            >
                ...
                <View className="flex-row px-6 mt-6 justify-between">
                    <View style={{ backgroundColor: colors.card, borderColor: colors.border }} className="w-[48%] p-5 rounded-[32px] items-center border shadow-sm">
                        ...
                        <Text style={{ color: colors.textSecondary }} className="text-[9px] font-black mt-3 mb-1 uppercase opacity-60">Created Date</Text>
                    ...
                    <View style={{ backgroundColor: colors.card, borderColor: colors.border }} className="w-[48%] p-5 rounded-[32px] items-center border shadow-sm">
                        ...
                        <Text style={{ color: colors.textSecondary }} className="text-[9px] font-black mt-3 mb-1 uppercase opacity-60">Category</Text>
                        <Text style={{ color: colors.text }} className="text-[11px] font-black uppercase" numberOfLines={1}>{ticket.category}</Text>
                    </View>
                </View>

                {/* Subject & Description */}
                <View className="px-8 mt-10">
                    <Text style={{ color: colors.textSecondary }} className="text-[11px] font-black tracking-[3px] mb-4 uppercase opacity-40">Ticket Subject</Text>
                    <Text style={{ color: colors.text }} className="text-xl font-black leading-8 mb-8 tracking-tight">
                        {ticket.subject}
                    </Text>

                    <Text style={{ color: colors.textSecondary }} className="text-[11px] font-black tracking-[3px] mb-4 uppercase opacity-40">Description Details</Text>
                ...
                {imageUri && (
                    <View className="px-6 mt-10">
                        <View className="mb-6 px-2">
                            <Text style={{ color: colors.textSecondary }} className="text-[11px] font-black tracking-[3px] uppercase opacity-40">Support Attachment</Text>
                        </View>
                    ...
                    <View style={{ backgroundColor: colors.card }} className="w-[90%] rounded-[48px] p-10 items-center shadow-2xl">
                        ...
                        <View style={{ backgroundColor: colors.surface }} className="w-full rounded-[32px] p-6 flex-row items-center mb-10">
                            ...
                            <View className="flex-1">
                                <Text style={{ color: colors.textSecondary }} className="text-[10px] font-black tracking-widest mb-1 opacity-40">EXPECTED RESPONSE</Text>
                                <Text style={{ color: colors.text }} className="text-sm font-black">Within 24 to 48 hours</Text>
                            </View>
                        </View>
